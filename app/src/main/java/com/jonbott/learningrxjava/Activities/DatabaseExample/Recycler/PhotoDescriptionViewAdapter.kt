...
class PhotoDescriptionViewAdapter(var onItemClicked: ItemClickedlambda): RecyclerView.Adapter<PhotoDescriptionViewHolder>() {
    ...
    /**
     * * As soon as the viewAdapter is created, add an observer on PhotoDescriptions.
     * Any changes to this will notify the adapter to update its data set, which updates the list view
     */
    init {
